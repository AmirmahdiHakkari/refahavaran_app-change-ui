...
export const _prices = [25000000, 3000000, 1400000, 9000000, 5120000];

export const _date = [1404 / 4 / 26, 1404 / 5 / 2, 1404 / 4 / 26, 1404 / 7 / 28, 1404 / 5 / 10];
...
export const _fullNames = ['رمزعبور', `کارت‌های ذخیره شده`];
export const _fullNames2 = [
  'راهنما',
  `درباره ما`,
  `گزارش تخلف فروشگاه`,
  `شرایط و مقررات`,
...
// Iconify identifiers mapped to each item in `_fullNames2` by index
export const FULLNAMES2_ICONS = [
...
export const _productNames = ['ال سی وایکیکی', 'روژا', 'میو گلد', 'ایران کتان', 'جین وست'];
